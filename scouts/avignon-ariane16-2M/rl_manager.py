...
class RLManager:
    ...
    def __init__(self):
        ...
        # configurations.
        self.model = DQN.load("scouts/avignon-ariane16-2M/avignon-ariane16_noGuards_2000000_steps")
        self.size = 16
    ...
    def rl(self, observation: dict[str, int | list[int]]) -> int:
        ...
        self.obs_repeat_space[*curr_location] += np.minimum(0.5, 1 - self.obs_repeat_space[*curr_location])
